    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row bg-gray-50">
                ...
                <div className="w-full max-w-md">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-500 text-sm">
                            Join and work together with other developers to build the future
                        </p>
                    </div>

                    {/* Social Sign Up Buttons */}
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <button className="flex items-center justify-center gap-2 p-3 border-2 border-gray-200 rounded-lg font-medium text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200">
                    ...
                    <form onSubmit={submitHandler} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 cursor-pointer bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                        >
                            Create Account
                        </button>
                    </form>
            ...
            <div className="lg:w-1/2 relative bg-gradient-to-br from-amber-400 via-yellow-500 to-amber-600 flex items-center justify-center p-8 lg:p-16 min-h-[40vh] lg:min-h-screen overflow-hidden order-1 lg:order-2">
                ...
                <div className="absolute top-20 left-10 bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-3 text-white text-xs font-mono opacity-60 hidden lg:block">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-black font-bold text-medium">CodexSpace</span>
                    </div>
                </div>
                <div className="absolute top-32 right-16 bg-white bg-opacity-10 backdrop-blur-sm rounded-full p-3 text-black text-xs font-mono opacity-60 hidden lg:block">
                    <div>{'const ai = "powered";'}</div>
                </div>

                {/* Content */}
                <div className="relative z-10 text-center lg:text-left max-w-lg">
                    <div className="mb-12">
                        <span className="inline-block px-4 py-2 bg-white bg-opacity-20 backdrop-blur-sm rounded-full text-black text-sm font-medium mt-24">
                            ✨ Sign up now to collaborate with your fellow developers
                        </span>
                    </div>
                    ...
                    <p className="text-white text-opacity-90 text-base lg:text-lg leading-relaxed mb-10">
                        CodexSpace brings developers together with real-time collaboration, AI assistance, and powerful tools to turn ideas into reality.
                    </p>
